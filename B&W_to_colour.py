...
numpy_file = np.load('./files/pts_in_hull.npy')
Caffe_net = cv.dnn.readNetFromCaffe("./files/colorization_deploy_v2.prototxt", "./files/colorization_release_v2.caffemodel")
...
img = ImageTk.PhotoImage(Image.open("./images/Ashruti.jpg"))
